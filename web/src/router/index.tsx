...
const AiInsights = lazyWithReload(() => import("@/pages/AiInsights"));
...
const RandomMemos = lazyWithReload(() => import("@/pages/RandomMemos"));
            ...
            children: [
              ...
              { path: "u/:username", element: <UserProfile /> },
              {
                ...
                children: [
                  ...
                  { path: Routes.RANDOM, element: <RandomMemos /> },
                  { path: Routes.INSIGHTS, element: <AiInsights /> },
                ],
              },
            ],
          },
