...
const TWO_ITEM_GRID_HEIGHT_CLASS = "h-[9.75rem] sm:h-[10.5rem]";
const MOSAIC_GRID_HEIGHT_CLASS = "h-[12rem] sm:h-[12.5rem]";
/** 2 rows × 3 columns */
const SIX_UP_GRID_HEIGHT_CLASS = "h-[12rem] sm:h-[12.5rem]";
