...
const PagedMemoList = (props: Props) => {
  ...
  const children = (
    <MentionResolutionProvider contents={sortedMemoList.map((memo) => memo.content)}>
      <div className="flex flex-col justify-start w-full max-w-[44rem] mx-auto">
        {/* Show skeleton loader during initial load */}
        {isLoading ? (
          <Skeleton showCreator={props.showCreator} count={4} />
        ) : (
          <>
            {showMemoEditor ? <MemoEditor className="mb-4" cacheKey="home-memo-editor" placeholder={t("editor.any-thoughts")} /> : null}
            <MemoFilters />
