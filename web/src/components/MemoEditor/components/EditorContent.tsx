...
export const EditorContent = forwardRef<EditorRefActions, EditorContentProps>(
  ({ placeholder, isActive, onFocusChange, editorRef }, ref) => {
    ...
    return (
      <div className="relative w-full flex flex-col flex-1" data-editor-suggestions-root="true" {...dragHandlers}>
        <Editor
          ref={ref}
        ...
        {editorRef && (
          <>
            <TagSuggestions editorRef={editorRef} />
            <SlashCommands editorRef={editorRef} commands={editorCommands} />
          </>
        )}
      </div>
    );
