...
const MemoExplorer = (props: Props) => {
  ...
  return (
    <aside
      className={cn(
        "relative w-full h-full overflow-auto flex flex-col justify-start items-start bg-transparent text-sidebar-foreground",
        className,
      )}
    >
      ...
      <div className="mt-3 px-1 w-full">
        ...
        {features.discovery && currentUser && <DiscoverySection />}
